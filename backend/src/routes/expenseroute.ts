...
import { createExpense, getExpenses, totalExpense, getExpenseCategoryData, getTransactions, getGraphData, getCategoryBreakdown, deleteTransaction, getAIAnalysis } from '../controllers/expenseController.js';
...
expenserouter.get('/category-breakdown', verifyToken, getCategoryBreakdown)

expenserouter.get('/ai-analysis', verifyToken, getAIAnalysis)

expenserouter.delete('/transaction/:transactionId', verifyToken, deleteTransaction)
